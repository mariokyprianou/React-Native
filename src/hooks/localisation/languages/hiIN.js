...
const hiIN = {
  ...
  AuthDict: {
    ...
    VerifyEmail:
      'हमने अभी-अभी आपको ईमेल किया है उस लिंक पर क्लिक करके अपना POWER खाता सत्यापित करें। अगर आपको 5 मिनट में हमारी ओर से कोई ईमेल नहीं मिला है, तो नीचे “पुन: भेजें” दबाएं',
